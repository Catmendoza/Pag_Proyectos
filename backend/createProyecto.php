...
$fec_ini_pro = $_POST["fec_ini_pro"] == "" ? "1900-05-02" : $_POST["fec_ini_pro"];
$fec_fin_pro = $_POST["fec_fin_pro"] == "" ? "1900-05-02" : $_POST["fec_fin_pro"];
...
try {
  if ($_FILES["arc_fis_pro"]["tmp_name"]) {
    move_uploaded_file($_FILES["arc_fis_pro"]["tmp_name"], "./" . $arc_fis_pro);
    //file_put_contents("/var/www/combita.company/otri/php/" . $arc_fis_pro, file_get_contents($_FILES["arc_fis_pro"]["tmp_name"]));
